                ...
                <div className="p5-y">
                    <div className="m5-b">
                        <div className="row">
                            <div className="col3">
                                <h5>Kontakt</h5>
                                <p className="m0-b">Email: adres@email.com</p>
                                <p>Tel: 123 456 789</p>
                            </div>
                            <div className="col3">
                                <h5>Socials</h5>
                                <div className="site-footer-socials d-is-flex">
                                    <a href="#">
                                        <div className="icon">
                            ...
                            <div className="col12 col3-md offset1-lg">
                                <h5>O nas</h5>
                                <div className="text9">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores doloribus pariatur, harum accusantium ratione dolorum aspernatur corrupti, vel deleniti culpa fuga molestiae saepe dolores, nisi mollitia minus deserunt autem reiciendis!
                                </div>
                            </div>
                            <div className="col12 col3-md col2-lg">
                                <ul className="site-footer-links m3-t m0-t-md">
                    ...
                    <footer>
                        ...
                        <span className="m1-l"><a href="#">localhost.com</a></span>
                    </footer>
                </div>
            </div>
        </div>
